<?php
  ...
  define('HTTP_COOKIE_PATH', '/CoolShop/admin');
  define('HTTPS_COOKIE_PATH', '/CoolShop/admin');
  ...
  define('DIR_WS_ADMIN', '/CoolShop/admin/');
  define('DIR_WS_HTTPS_ADMIN', '/CoolShop/admin/');
  define('DIR_FS_ADMIN', '/var/www/html/catalog/admin/');
  define('DIR_WS_CATALOG', '/CoolShop/');
